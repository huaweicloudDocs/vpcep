...
5.  根据界面提示配置参数，参数说明如[表1 终端节点服务配置参数](#zh-cn_topic_0132331143_table20351132821713)所示。
    ...
    **表 1**  终端节点服务配置参数
    ...
    <p id="p987118118312"><a name="p987118118312"></a><a name="p987118118312"></a>端口映射添加完成后不支持修改或者删除。</p>
    </div></div>
    </td>
    </tr>
    ...
    <td class="cellrowborder" valign="top" width="79.46%" headers="mcps1.2.3.1.2 "><p id="p154192112610"><a name="p154192112610"></a><a name="p154192112610"></a>“后端资源类型”选择为“弹性负载均衡”时，会出现该参数，在下拉列表中选择需要提供服务的负载均衡，只支持弹性负载均衡。</p>
