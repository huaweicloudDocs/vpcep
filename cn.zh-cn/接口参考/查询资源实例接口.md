# 查询资源实例接口<a name="ZH-CN_TOPIC_0193278194"></a>
...
-   参数说明
    ...
    **表 3**  要素说明
    ...
    <tr id="row77681940163117"><td class="cellrowborder" valign="top" width="21.42785721427857%" headers="mcps1.2.5.1.1 "><p id="p15768740183118"><a name="p15768740183118"></a><a name="p15768740183118"></a>without_any_tag</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.328367163283673%" headers="mcps1.2.5.1.2 "><p id="p1376854093116"><a name="p1376854093116"></a><a name="p1376854093116"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="17.348265173482652%" headers="mcps1.2.5.1.3 "><p id="p18768114011315"><a name="p18768114011315"></a><a name="p18768114011315"></a>Boolean</p>
    </td>
    <td class="cellrowborder" valign="top" width="44.89551044895511%" headers="mcps1.2.5.1.4 "><p id="p576864023117"><a name="p576864023117"></a><a name="p576864023117"></a>不包含任意一个标签，该字段为true时查询所有不带标签的资源，此时忽略“tags”、“tags_any”、“not_tags”、“not_tags_any”字段。</p>
    </td>
    </tr>
    </tbody>
    </table>
...
-   请求样例
    ...
    POSThttps://127.0.0.1:7443/v1/\{project\_id\}/endpoint\_service/resource\_instances/action

    或https://127.0.0.1:7443/v1/\{project\_id\}/endpoint/resource\_instances/action
...
-   参数说明
    ...
    **表 7**  resource 字段数据结构说明
    ...
    <tr id="row1177194017319"><td class="cellrowborder" valign="top" width="20.41%" headers="mcps1.2.5.1.1 "><p id="p47711840133116"><a name="p47711840133116"></a><a name="p47711840133116"></a>resource_detail</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.37%" headers="mcps1.2.5.1.2 "><p id="p9771184033116"><a name="p9771184033116"></a><a name="p9771184033116"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="21.65%" headers="mcps1.2.5.1.3 "><p id="p1377104014317"><a name="p1377104014317"></a><a name="p1377104014317"></a>Object</p>
    </td>
    <td class="cellrowborder" valign="top" width="39.57%" headers="mcps1.2.5.1.4 "><p id="p12771164043112"><a name="p12771164043112"></a><a name="p12771164043112"></a>资源详情。资源对象，用于扩展。默认为空。</p>
    </td>
    </tr>
