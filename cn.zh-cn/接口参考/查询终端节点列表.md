# 查询终端节点列表<a name="zh-cn_topic_0130978821"></a>
...
-   参数说明
    ...
    **表 2**  请求参数
    ...
    <tr id="row15357778"><td class="cellrowborder" valign="top" width="28.56714328567143%" headers="mcps1.2.5.1.1 "><p id="p36020529"><a name="p36020529"></a><a name="p36020529"></a>id</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.268673132686734%" headers="mcps1.2.5.1.2 "><p id="p31981732"><a name="p31981732"></a><a name="p31981732"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="13.268673132686734%" headers="mcps1.2.5.1.3 "><p id="p40383508"><a name="p40383508"></a><a name="p40383508"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="44.89551044895511%" headers="mcps1.2.5.1.4 "><p id="p49838696"><a name="p49838696"></a><a name="p49838696"></a>终端节点的ID，唯一标识。</p>
    </td>
    </tr>
...
-   参数说明
    ...
    **表 4**  endpoint要素说明
    ...
    <td class="cellrowborder" valign="top" width="59.27%" headers="mcps1.2.4.1.3 "><p id="p42197171418"><a name="p42197171418"></a><a name="p42197171418"></a>终端节点服务类型。仅支持将用户私有服务创建为interface类型的终端节点服务。</p>
    ...
    <td class="cellrowborder" valign="top" width="59.27%" headers="mcps1.2.4.1.3 "><p id="p14324144165119"><a name="p14324144165119"></a><a name="p14324144165119"></a>账户状态。</p>
    ...
    <p id="p45203393322"><a name="p45203393322"></a><a name="p45203393322"></a>当终端节点状态异常，即“status”的值为“failed”时，会返回该字段，详细内容请参见<a href="#table1736562411812">表5</a>。</p>
    </td>
    </tr>
