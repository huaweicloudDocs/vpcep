...
-   参数说明
    ...
    **表 2**  请求参数
    ...
    <div class="note" id="note1812420102012"><a name="note1812420102012"></a><a name="note1812420102012"></a><span class="notetitle"> 说明： </span><div class="notebody"><p id="p1781913454344"><a name="p1781913454344"></a><a name="p1781913454344"></a>当后端资源为“LB类型”时，仅支持修改为同类型后端资源的“vip_port_id”。</p>
    <p id="p1212515020209"><a name="p1212515020209"></a><a name="p1212515020209"></a>例如，共享型负载均衡仅支持更换为共享型负载均衡，不支持更换为独享型负载均衡。</p>
    </div></div>
    </td>
    </tr>
    ...
    **表 3**  Port要素说明
    ...
    <td class="cellrowborder" valign="top" width="52.91470852914708%" headers="mcps1.2.5.1.4 "><p id="vpcep_06_0201_p19429767"><a name="vpcep_06_0201_p19429767"></a><a name="vpcep_06_0201_p19429767"></a>端口映射协议，支持TCP。</p>
    </td>
    </tr>
    </tbody>
    </table>
