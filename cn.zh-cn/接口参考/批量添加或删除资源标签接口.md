# 批量添加或删除资源标签接口<a name="BatchAddOrRemoveResourceInstance"></a>
...
您可以在[API Explorer](https://apiexplorer.developer.huaweicloud.com/apiexplorer/doc?product=VPCEP&api=BatchAddOrRemoveResourceInstance)中调试该接口，支持自动认证鉴权。API Explorer可以自动生成SDK代码示例，并提供SDK代码示例调试功能。
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>资源ID，Endpoint ServiceID或Endpoint ID。</p>
</td>
</tr>
</tbody>
</table>
...
<a name="request_BatchAddOrRemoveResourceInstanceBody"></a>
<table><thead align="left"><tr><th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.1"><p>参数</p>
</th>
<th class="cellrowborder" valign="top" width="20%" id="mcps1.2.5.1.2"><p>是否必选</p>
</th>
...
<td class="cellrowborder" valign="top" width="20%" headers="mcps1.2.5.1.3 "><p>Array of <a href="#request_resource_tag">resource_tag</a> objects</p>
</td>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>操作标识：仅限于 create（创建） delete（删除）</p>
</td>
</tr>
</tbody>
</table>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>键。最大长度36个unicode字符。 key需要满足标签字符集规范。</p>
</td>
</tr>
...
<td class="cellrowborder" valign="top" width="40%" headers="mcps1.2.5.1.4 "><p>值。action为create时必选，每个值最大长度43个unicode字符， 删除时如果value有值按照key/value删除， 如果value没值，则按照key删除。 value需要满足标签字符集规范。</p>
</td>
</tr>
</tbody>
</table>
