...
GET /v1/\{project\_id\}/vpc-endpoint-services/\{vpc\_endpoint\_service\_id\}/permissions?permission=\{permission\}&sort\_dir=\{sort\_dir\}&limit=\{limit\}&offset=\{offset\}
...
-   参数说明
    ...
    **表 2**  请求参数
    ...
    <tbody><tr id="row13678197122319"><td class="cellrowborder" valign="top" width="19.388061193880613%" headers="mcps1.2.5.1.1 "><p id="p206781178233"><a name="p206781178233"></a><a name="p206781178233"></a>permission</p>
    </td>
    <td class="cellrowborder" valign="top" width="18.36816318368163%" headers="mcps1.2.5.1.2 "><p id="p2678117182316"><a name="p2678117182316"></a><a name="p2678117182316"></a>否</p>
    </td>
    <td class="cellrowborder" valign="top" width="16.328367163283673%" headers="mcps1.2.5.1.3 "><p id="p1767810720237"><a name="p1767810720237"></a><a name="p1767810720237"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="45.91540845915409%" headers="mcps1.2.5.1.4 "><p id="p943616304386"><a name="p943616304386"></a><a name="p943616304386"></a>权限<span id="text16131185717402"><a name="text16131185717402"></a><a name="text16131185717402"></a></span><span id="text0290194116"><a name="text0290194116"></a><a name="text0290194116"></a>帐号</span>ID，格式为“iam:domain::domain_id”。</p>
    <p id="p1522916412237"><a name="p1522916412237"></a><a name="p1522916412237"></a>其中“domain_id”为授权用户的<span id="text18134173414"><a name="text18134173414"></a><a name="text18134173414"></a></span><span id="text235714182415"><a name="text235714182415"></a><a name="text235714182415"></a>帐号</span>ID，例如“iam:domain::6e9dfd51d1124e8d8498dce894923a0d”。</p>
    <p id="p14770432173810"><a name="p14770432173810"></a><a name="p14770432173810"></a>支持模糊搜索。</p>
    </td>
    </tr>
    <tr id="row2154176"><td class="cellrowborder" valign="top" width="19.388061193880613%" headers="mcps1.2.5.1.1 "><p id="p40270548"><a name="p40270548"></a><a name="p40270548"></a>limit</p>
    </td>
    ...
    <td class="cellrowborder" valign="top" width="45.91540845915409%" headers="mcps1.2.5.1.4 "><p id="p562418271823"><a name="p562418271823"></a><a name="p562418271823"></a>查询结果中白名单列表的排序字段，取值为create_at，表示白名单的添加时间。</p>
    </td>
    </tr>
