# 查询终端节点详情<a name="zh-cn_topic_0130978818"></a>
...
-   参数说明
    ...
    **表 2**  响应参数
    ...
    <td class="cellrowborder" valign="top" width="62.17621762176218%" headers="mcps1.2.4.1.3 "><p id="p1128513591836"><a name="p1128513591836"></a><a name="p1128513591836"></a>终端节点服务类型。仅支持将用户私有服务创建为interface类型的终端节点服务。</p>
    ...
    <td class="cellrowborder" valign="top" width="62.17621762176218%" headers="mcps1.2.4.1.3 "><p id="p14324144165119"><a name="p14324144165119"></a><a name="p14324144165119"></a>账户状态。</p>
    ...
    <td class="cellrowborder" valign="top" width="62.17621762176218%" headers="mcps1.2.4.1.3 "><p id="p58649253"><a name="p58649253"></a><a name="p58649253"></a>访问所连接的终端节点服务的IP。</p>
    </td>
    </tr>
    ...
    <p id="p45203393322"><a name="p45203393322"></a><a name="p45203393322"></a>当终端节点状态异常，即“status”的值为“failed”时，会返回该字段，详细内容请参见<a href="#table14419242754">表3</a>。</p>
    </td>
    </tr>
