# 查询终端节点服务列表<a name="zh-cn_topic_0130978809"></a>
...
-   参数说明
    ...
    **表 4**  endpoint\_service要素说明
    ...
    <tr id="row95921727101411"><td class="cellrowborder" valign="top" width="19.59%" headers="mcps1.2.4.1.1 "><p id="p11159833101419"><a name="p11159833101419"></a><a name="p11159833101419"></a>marker_id</p>
    </td>
    <td class="cellrowborder" valign="top" width="19.59%" headers="mcps1.2.4.1.2 "><p id="p1815912331146"><a name="p1815912331146"></a><a name="p1815912331146"></a>Integer</p>
    </td>
    <td class="cellrowborder" valign="top" width="60.81999999999999%" headers="mcps1.2.4.1.3 "><p id="p11159433191417"><a name="p11159433191417"></a><a name="p11159433191417"></a>数字唯一标示。</p>
    </td>
    </tr>
    ...
    <tr id="row18635163451514"><td class="cellrowborder" valign="top" width="19.59%" headers="mcps1.2.4.1.1 "><p id="p127281142141520"><a name="p127281142141520"></a><a name="p127281142141520"></a>service_port</p>
    </td>
    <td class="cellrowborder" valign="top" width="19.59%" headers="mcps1.2.4.1.2 "><p id="p572834231518"><a name="p572834231518"></a><a name="p572834231518"></a>String</p>
    </td>
    <td class="cellrowborder" valign="top" width="60.81999999999999%" headers="mcps1.2.4.1.3 "><p id="p9728164218159"><a name="p9728164218159"></a><a name="p9728164218159"></a>服务开放的端口号。</p>
    </td>
    </tr>
    ...
    <p id="p2478152724413"><a name="p2478152724413"></a><a name="p2478152724413"></a>当终端节点服务状态异常，即“status”的值为“failed”时，会返回该字段，详细内容请参见<a href="#table178701348456">表6</a>。</p>
    </td>
    </tr>
    </tbody>
    </table>
